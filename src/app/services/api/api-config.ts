export class ApiConfig {
  ...
  public static FAMILLE_GAMME = ApiConfig.BASE_API + '/FamillesGamme';
  ...
  public static COUPE_DE_PRINCIPE = ApiConfig.BASE_API + '/coupesDePrincipe';
  ...
  public static MODULE_BASE = ApiConfig.BASE_API + '/ModulesBase';
  public static MODULE_BASE_UNIQUE = ApiConfig.MODULE_BASE + '/:id';
  public static MODULE_BASE_EXISTS = ApiConfig.MODULE_BASE_UNIQUE + '/exists';
  public static MODULE_BASE_COUNT = ApiConfig.MODULE_BASE + '/count';
