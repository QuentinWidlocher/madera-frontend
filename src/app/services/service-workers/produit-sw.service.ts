                    ...
                    result = new Promise(rslv => {
                        ...
                        this.api.getAll().subscribe((produits: Produit[]) => {
                            ...
                            produits.forEach((produit, index) => {
                                ...
                                produits[index].modeles = produit.modeles.map(modele => Object.assign(Modele.newEmpty(), modele));
                                produits[index].modules = produit.modules.map(module => Object.assign(Module.newEmpty(), module));
                            });
                ...
                if (isConnected) {
                    ...
                    result = new Promise(rslv => {
                        this.api.get(id).subscribe((produit: Produit) => {
                            ...
                            produit.modeles = produit.modeles.map(modele => Object.assign(Modele.newEmpty(), modele));
                            produit.modules = produit.modules.map(module => Object.assign(Module.newEmpty(), module));
                ...
                if (isConnected) {
                    ...
                    result = new Promise(rslv => {
                        ...
                        this.api.add(produit).subscribe((added: Produit) => {
                            ...
                            added.modeles = produit.modeles;
                            added.modules = produit.modules;
