                    ...
                    result = new Promise(rslv => {
                        ...
                        this.api.getAll().subscribe((modules: Module[]) => {
                            ...
                            modules.forEach((module, index) => {
                                ...
                                modules[index].composants = module.composants.map(composant => Object.assign(Composant.newEmpty(), composant));
                                modules[index].coupeDePrincipe = Object.assign(CoupeDePrincipe.newEmpty(), module.coupeDePrincipe);
                                modules[index].produits = module.produits.map(produit => Object.assign(Produit.newEmpty(), produit));
                ...
                if (isConnected) {
                    ...
                    result = new Promise(rslv => {
                        this.api.get(id).subscribe((module: Module) => {
                            ...
                            module.composants = module.composants.map(composant => Object.assign(Composant.newEmpty(), composant));
                            module.coupeDePrincipe = Object.assign(CoupeDePrincipe.newEmpty(), module.coupeDePrincipe);
                            module.produits = module.produits.map(produit => Object.assign(Produit.newEmpty(), produit));
