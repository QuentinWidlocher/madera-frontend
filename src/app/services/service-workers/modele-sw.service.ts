                    ...
                    result = new Promise(rslv => {
                        ...
                        this.api.getAll().subscribe((modeles: Modele[]) => {
                            ...
                            modeles.forEach((modele, index) => {
                                ...
                                modeles[index].produits = modele.produits.map(produit => Object.assign(Produit.newEmpty(), produit));
                ...
                if (isConnected) {
                    ...
                    result = new Promise(rslv => {
                        this.api.get(id).subscribe((modele: Modele) => {
                            ...
                            modele.produits = modele.produits.map(produit => Object.assign(Produit.newEmpty(), produit));
                ...
                if (isConnected) {
                    ...
                    result = new Promise(rslv => {
                        ...
                        this.api.add(modele).subscribe((added: Modele) => {
                            ...
                            added.produits = modele.produits;
