...
export class Caracteristique {
    ...
    constructor(id: number, description: string, value: number, module: Module, composant: Composant, unite: Unite) {
        this.id = id;
    ...
    public static newEmpty(): Caracteristique {
        return new Caracteristique(undefined, undefined, undefined, undefined, undefined, undefined);
    }
